...
import { deleteFromCouldinary, uploadOnCloudinary } from "../utils/cloudinary.js";
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    if (!loggedInUser){
        throw new ApiError(400, "Cannot login user")
    }

    const options = {
        httpOnly: true, // makes the cookie not modifiable by client 
